...
const aBuffs = {
    ...
    applyOnFriend: function (buff, amount, friend) {
        ...
        var responder = game.createResponder(function (e, d) { console.error(d) });
            ...
            $.each(Buildings, function (i, building) {
                switch (building.GetResourceCreation().GetProductionState()) {
                    ...
                    case 5: // STOPPED_PRODUCTION
                        ...
                        break;
                    default:
                        console.error('Unkown Production State "{0}"!'.format(building.GetResourceCreation().GetProductionState()));
                }
            });
            ...
            try {
                ...
                $.get(auto.update.url() + 'user_auto.js', function (data) {
                    try {
                        ...
                        console.error('Update write failed: ' + writeError);
